...
<head>
    ...
    <title>PainDiary: User Board</title>
...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                  ...
                  <a href="?saved-reports"><i class="fas fa-clipboard-list"></i> Saved Symptom</a>
                </li>
            </ul>
        ...
        <div id="content">
            ...
            <h2 style="text-align: center;">Symptom info</h2>
            <div class="line"></div>
                <div class="row py-5">
